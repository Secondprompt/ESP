...
const char* ssid = "procodecg router";
const char* password = "procodecg";
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    // Attempt to connect
    if (client.connect(clientId.c_str(), "PROCODECG-TP-LINK_81AE", "procodecg")) {
      Serial.println("connected");
      // Once connected, publish an announcement...
      //client.publish("procodecg/procodecgproject/data", "hello world");
      // ... and resubscribe
